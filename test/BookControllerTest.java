...
import Controller.BookWriterServiceImpl;
import mocks.BookWriterServiceMock;
import model.Book;
...
public class BookControllerTest {
    ...
    //  private final String FILE_NAME = "product.bin";

    @BeforeEach
    public void setUp() {
        bookWriterServiceMock = new BookWriterServiceImpl();
...
//        File testFile = new File("testFile.bin");
        // Create a test instance of BookController with the mocked BookWriter
